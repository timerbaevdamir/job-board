      ...
      >
        ...
        {chrome !== "pane" && d?.contactName && (
          <section className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-4 rounded-[28px] border border-border-strong/70 bg-surface p-4 md:rounded-[20px] md:flex-row md:items-center md:justify-between">
